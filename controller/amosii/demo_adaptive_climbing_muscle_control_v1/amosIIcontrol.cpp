...
//    addInspectableValue("pCPGtest1",&control_adaptiveclimbing.test_pcpg_output.at(1),"pCPGtest1");
    ...
    addInspectableValue("r0",&control_adaptiveclimbing.Raw_R_fs.at(0),"PSN0");
    addInspectableValue("r1",&control_adaptiveclimbing.Raw_R_fs.at(1),"PSN1");
    addInspectableValue("r2",&control_adaptiveclimbing.Raw_R_fs.at(2),"VRN0");
    addInspectableValue("l0",&control_adaptiveclimbing.Raw_L_fs.at(0),"VRN1");
    addInspectableValue("l1",&control_adaptiveclimbing.Raw_L_fs.at(1),"VRN1");
    addInspectableValue("l2",&control_adaptiveclimbing.Raw_L_fs.at(2),"VRN1");

    addInspectableValue("IRright",&preprocessing_learning.preprosensor.at(FR_us),"VRN1");
    addInspectableValue("IRleft",&preprocessing_learning.preprosensor.at(FL_us),"VRN1");
