 ...
 *      Author: poramate
 *
 *      NeuralLocomotionControlAdaptiveClimbing_R1R3L2.cpp
 *      Working perfect!
 *
 *      With default tripod gait  = turn right in sim
 *
 *           //    step_tmp = global_count;
      ChaosCont.setPeriod(4); //RF
      ChaosCont.setPeriod_cli(4); //RM
...
NeuralLocomotionControlAdaptiveClimbing::NeuralLocomotionControlAdaptiveClimbing() {
  ...
  //Control option:
   ...
   learned_gait = false;//if set to true = use learned gait, if set to false = use all period 4 (default tripod gait)
  ...
  LegDamage_flag[LEG_LM] = true; //false;
...
// 	     deviation_distance_used = 3;
  ...
  if(lift_body_up==true)
  {
    ...
    {
      int lifting_value = 10;//10;//5;//10; //20
