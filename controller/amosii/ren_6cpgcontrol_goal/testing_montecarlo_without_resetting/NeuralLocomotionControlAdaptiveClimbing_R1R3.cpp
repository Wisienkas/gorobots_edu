 ...
 *      Author: poramate
 *      NeuralLocomotionControlAdaptiveClimbing_R1R3.cpp
 *      Work OK
 *
 *      with default tripod gait = Turn right_ fail in sim
 *
 *            ChaosCont.setPeriod(4); //RF
      ChaosCont.setPeriod_cli(4); //RM
      ChaosCont.setPeriod_cli1(4); //RH
      ChaosCont.setPeriod_cli2(6); //LF
