 ...
 *      Author: poramate
 *      NeuralLocomotionControlAdaptiveClimbing_R1.cpp
 *      WORK perfect
 *
 *      With default tripod gait = turn right fail in sim
 *
 *         ChaosCont.setPeriod(4); //RF
      ChaosCont.setPeriod_cli(5); //RM
      ChaosCont.setPeriod_cli1(4); //RH
      ChaosCont.setPeriod_cli2(5); //LF
      ChaosCont.setPeriod_cli3(6); //LM
      ChaosCont.setPeriod_cli4(5); //LH
 */
...
// 	     deviation_distance_used = 3;
  ...
  if(lift_body_up==true)
  {
    ...
    {
      int lifting_value = 5;//10;//5;//10; //20
