...
//BasicController::BasicController(const std::string& name): AbstractController(name, "1.0") {
//    initialised = false;
//    // add threshold parameter to online configurable parameters, setable on console
