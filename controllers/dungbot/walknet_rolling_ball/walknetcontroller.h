...
class walknetcontroller
{
	...
	void frontLegWalk( const sensor* sensor, std::vector<std::vector<double>> &, std::vector<std::vector<double>> & );
	...
	void coordinateRule1( const sensor* );
	void coordinateRule2( const sensor* );
	void coordinateRule3( const sensor* );
	void coordinateRule4( const sensor* );
