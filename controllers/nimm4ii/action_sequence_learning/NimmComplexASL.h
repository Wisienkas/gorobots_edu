 ...
 *                                                                         *
 ***************************************************************************/
#ifndef _NIMM_COMPLEX_H_
#define _NIMM_COMPLEX_H_
...
using namespace std;
//Save files
#include "NimmComplexRobotStateASL.h"
...
class NimmComplex : public AbstractController {
...
//	ofstream outFilevtcurveY;
	...
	NimmComplexRobotState robotstate;
	...
	void get_v_action_pair_from_RBF_network(double* xt, double* rbf_out);
	...
	NimmComplex(const NimmComplexConf& conf = getDefaultConf());
  ...
  virtual paramlist getParamList() const;
	...
	static NimmComplexConf getDefaultConf(){
		NimmComplexConf c;
