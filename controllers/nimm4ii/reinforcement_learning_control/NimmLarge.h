...
class NimmLarge : public AbstractController {
...
//	ofstream outFilevtcurveY;
	...
	NimmLargeRobotState robotstate;
	...
	NimmLarge(const NimmLargeConf& conf = getDefaultConf());
  ...
  virtual paramlist getParamList() const;
	...
	static NimmLargeConf getDefaultConf(){
		NimmLargeConf c;
