 ...
 *                                                                         *
 ***************************************************************************/
#ifndef _NIMM_EXP2_H_
#define _NIMM_EXP2_H_
...
class NimmExp2 : public AbstractController {

public:
	double received_landmark_anglel;
	...
	NimmExp2(const NimmExp2Conf& conf = getDefaultConf());
  ...
  virtual paramlist getParamList() const;
	...
	static NimmExp2Conf getDefaultConf(){
		NimmExp2Conf c;
