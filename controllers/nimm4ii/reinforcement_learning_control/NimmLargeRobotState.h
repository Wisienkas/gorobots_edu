/*
 * NimmLargeRobotState.h
 *
 *  Created on: Jul 24, 2013
 *      Author: bassel
 */

#ifndef NimmLargeRobotState_H_
#define NimmLargeRobotState_H_
