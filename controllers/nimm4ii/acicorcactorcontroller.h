 ...
 *                                                                         *
 ***************************************************************************/
#ifndef __ACICOCONTROLLERV14_H
#define __ACICOCONTROLLERV14_H
...
#define MAX_IN0 2.0//M_PI/2  //2 M_PI/2 (1.578) // max sensory input0 range ** Set for different system
#define MIN_IN0 -2.0//-M_PI/2 //-2 -M_PI/2 (1.578) // min sensory input0 range ** Set for different system

#define MAX_IN1 2.0//1.0 // max sensory input1 range ** Set for different system
#define MIN_IN1 -2.0//0.0 // min sensory input1 range ** Set for different system

//---NOT USED in this setup
#define MAX_IN2 2.0//3.0  // max sensory input1 range ** Set for different system
#define MIN_IN2 0.0 // min sensory input1 range ** Set for different system

#define MAX_IN3 2.0//3.0  // max sensory input1 range ** Set for different system
#define MIN_IN3 0.0 // min sensory input1 range ** Set for different system
...
struct AcIcoRcActorControllerConf{
} ;
 ...
 */
class AcIcoRcActorController : public AbstractController {
...
//	ofstream outFilevtcurveY;
	...
	AcIcoRcActorController(const AcIcoRcActorControllerConf& conf = getDefaultConf());
	virtual void init(int sensornumber, int motornumber, RandGen* randGen = 0);

	virtual ~AcIcoRcActorController();
  ...
  virtual paramlist getParamList() const;
	...
	static AcIcoRcActorControllerConf getDefaultConf(){
		AcIcoRcActorControllerConf c;
  ...
  void calculateAngleReflexSignals(const sensor* x_);
	...
	double  error_thresh; // error threshold for changing weights of critic
	double  unit_activation_thresh; // threshold of critic unit for changing weights
	double  Vt;
	double  td_error_old;
...
protected:
	AcIcoRcActorControllerConf conf;
