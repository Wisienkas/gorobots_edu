 ...
 */
class AmosOG : public AbstractController {
...
//	ofstream outFilevtcurveY;
	...
	AmosOG(const AmosOGConf& conf = getDefaultConf());
  ...
  virtual paramlist getParamList() const;
	...
	static AmosOGConf getDefaultConf(){
		AmosOGConf c;
