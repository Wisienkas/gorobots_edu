...
int main(int argc, char** argv) {
	...
	for (unsigned int i = TR0_m; i < (BJ_m); i++) {
		((AmosIIControl*) controller)->control_adaptiveclimbing.motormap.at(i)->max_ctr = 150;//130
		((AmosIIControl*) controller)->control_adaptiveclimbing.motormap.at(i)->max_ctr_offset = 130;//120
	}
	...
	while(!stop) {
		...
		if (key==102){ //F
					if (((AmosIIControl*) controller)->control_adaptiveclimbing.stop) {
						((AmosIIControl*) controller)->control_adaptiveclimbing.stop = false;
						((AmosIIControl*) controller)->control_adaptiveclimbing.switchon_reflexes=true;
						((AmosIIControl*) controller)->control_adaptiveclimbing.switchon_irreflexes=true;
						((AmosIIControl*) controller)->control_adaptiveclimbing.switchon_purefootsignal=true;
						...
						((AmosIIControl*) controller)->control_adaptiveclimbing.stop = true;
						((AmosIIControl*) controller)->control_adaptiveclimbing.switchon_reflexes=false;
						((AmosIIControl*) controller)->control_adaptiveclimbing.switchon_irreflexes= false;
						((AmosIIControl*) controller)->control_adaptiveclimbing.switchon_purefootsignal=false;
						std::cout << "Stop" << endl;
						((AmosIIControl*) controller)->control_adaptiveclimbing.input.at(3)=0;
						((AmosIIControl*) controller)->control_adaptiveclimbing.input.at(4)=0;
					}
				}
