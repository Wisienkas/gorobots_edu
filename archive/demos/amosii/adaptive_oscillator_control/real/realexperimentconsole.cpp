 ...
 *    Timo Nachstedt <timo dot nachstedt at gmail dot com>                 *
 *                                                                         *
...
typedef bool (*commandfunc_t)(RealExperimentGlobalData& globalData, char *, char *);
/* The names of functions that actually do the manipulation.  parameter: global data, entire line, arg */
bool com_list (RealExperimentGlobalData& globalData, char *, char *);
bool com_show (RealExperimentGlobalData& globalData, char *, char *);
bool com_storecfg (RealExperimentGlobalData& globalData, char *, char *);
bool com_loadcfg (RealExperimentGlobalData& globalData, char *, char *);
bool com_set (RealExperimentGlobalData& globalData, char *, char *);
bool com_help (RealExperimentGlobalData& globalData, char *, char *);
bool com_quit (RealExperimentGlobalData& globalData, char *, char *);
...
bool execute_line (RealExperimentGlobalData& globalData, char *line);
...
bool handleConsole(RealExperimentGlobalData& globalData){
  char *line, *s;
  bool rv = true;
...
bool com_list (RealExperimentGlobalData& globalData, char* line, char* arg) {
  int i=1;
...
bool com_show (RealExperimentGlobalData& globalData, char* line, char* arg) {
  if (arg && *arg){
    int id = atoi(arg);
...
bool com_set (RealExperimentGlobalData& globalData, char* line, char* arg) {
...
bool com_storecfg (RealExperimentGlobalData& globalData, char* line, char* arg) {
...
bool com_loadcfg (RealExperimentGlobalData& globalData, char* line, char* arg) {
...
/* Print out help for ARG, or for all of the commands if ARG is
   not present. */
bool com_help (RealExperimentGlobalData& globalData, char* line, char* arg) {
  register int i;
  int printed = 0;
