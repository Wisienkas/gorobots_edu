...
class ESNetwork{
  public :
    ...
    ESNetwork(int a, int b, int c, bool param1 = false, bool param2 = false, double param3 = 0.0 /*0.3*/, bool param4= false);
    ...
    void generate_random_weights(int sparsity = 95 /*95*/, float spectral_radius = 0.95 /*0.95*/);
    ...
    void takeStep(float * Outputs, float learningRate, float td_error, bool learn = true, int timestep = 101);
    /*
