 ...
 *    fhesse@informatik.uni-leipzig.de                                     *lk
...
public:
  ...
  void start(const OdeHandle& odeHandle, const OsgHandle& osgHandle, GlobalData& global)
  {
    ...
    // initialization
    // - set noise to 0.1
    global.odeConfig.noise=0.0005;
    global.odeConfig.setParam("gravity", -1.5);
...
//     vehicle->place(Pos(0,0,0));
    ...
    // - place robot
    OdeRobot* vehicle = new nimm4_doublePole(odeHandle, osgHandle, "Nimm4");
    AbstractController *controller = new newACICO("ACICO", "v15");
    //global.configs.push_back(controller);

    ((nimm4_doublePole*)vehicle)->controller = controller;

    vehicle->place(Pos(0,1,0.2));
