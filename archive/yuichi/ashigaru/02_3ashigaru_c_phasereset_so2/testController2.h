 ...
 *                                                                         *
 ***************************************************************************/
#ifndef __TESTCONTROLLER2_H
#define __TESTCONTROLLER2_H
...
typedef struct TestController2Conf {
    double WeightH1_H1;
    double WeightH2_H2;
    double WeightH1_H2;
    double WeightH2_H1;
 ...
 *
 */
class TestController2 : public AbstractController {

  public:
    TestController2(std::string name, double ini, const TestController2Conf& conf = getDefaultConf());

    virtual void init(int sensornumber, int motornumber, RandGen* randGen = 0);

    virtual ~TestController2();
    ...
    // default config
    static TestController2Conf getDefaultConf();
