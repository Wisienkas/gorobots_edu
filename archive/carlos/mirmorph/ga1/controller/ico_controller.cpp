...
void IcoController::step(const sensor* sensors, int sensornumber,
    ...
    ico_controller[0]->setPredictiveNeuronWeight(0, 2.42986);
    ico_controller[1]->setPredictiveNeuronWeight(0, 0.810415);
    ico_controller[2]->setPredictiveNeuronWeight(0, 3.25213);
