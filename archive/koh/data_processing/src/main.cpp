...
int main( int argc, char ** argv ) {
  ...
  if( argc == 1 ) { // XXX Manual mode
    ...
    double leak                         = 0.33;
    double percentage_1                 = 50.0; // Number of data for Learning in 80%
    double percentage_2                 = 50.0; // Number of remaining data: 25% for testing and 25% for validation
    ...
    {
      percentage_1                 = 0.0; // Number of data for Learning in 0%
      percentage_2                 = 0.0; // Number of remaining data: 100% for 0% validation and 100 %testing
      EMGapproxESN * app2 = new EMGapproxESN(
          inputPath,
          targetPath,
          resultPath,
          saveDir,
