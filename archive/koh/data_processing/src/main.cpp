...
int main( int argc, char ** argv ) {
    ...
    if( argc == 1 ) { // XXX Manual mode
        ...
        string inputPath                    = "resources/withoutCF/maturingsalmon/Input13_89.txt";
        string targetPath                   = "resources/withoutCF/maturingsalmon/Target13_89.txt";
        ...
        unsigned int numberOfHiddenUnits    = 50;//50
