...
void ACICOControllerV14::calculateAnglePositionFromSensors(const sensor* x_)
{
	int i=0;
...
void ACICOControllerV14::get_ir_signals(const sensor* x_)
{
...
void ACICOControllerV14::print_to_cout(int steps_period)
{
...
void ACICOControllerV14::reset_params()
{
...
void ACICOControllerV14::save_inputs()
{
	ofstream _file;
...
void ACICOControllerV14::save_output()
{
	ofstream _file;
...
void ACICOControllerV14::copy_input(double* inputs, double* inputs_old)
{
	for (int i=0; i<XDIM; i++) {
...
void ACICOControllerV14::controller_core(const sensor* x_, int number_sensors, motor* y_, int number_motors)
{
...
void ACICOControllerV14::get_v_action_pair_from_RBF_network(double* xt, double* rbf_out) {
	double u_tmp1[2];
	u_tmp1[0] = 0.0;
	u_tmp1[1] = 0.0;
...
void ACICOControllerV14::update_rbf_network(double* input_old, double td_error, double td_actor, double rate_valuefunction, double p_error, double rate_policy) {
...
void ACICOControllerV14::update_policy_actor(double td_error, double rate, double* input)
{
	//int i;
