 ...
 *      Author: bassel
 */
//RobotState - nimm large environment
/*************************************************************************
...
double RobotState::bind_exploration(double actor_out, double &exploration, bool ico_param)
{
...
void RobotState::submit_sample(double* inputs, double td_v, double td_actor, double perror) {
	Sample s;
	for (int i=0; i<4; i++)
...
std::vector<Sample> RobotState::get_samples() {
	return this->samples;
}
