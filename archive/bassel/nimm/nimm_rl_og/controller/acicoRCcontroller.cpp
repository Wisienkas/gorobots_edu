...
double ACICOControllerV14::get_exploration(double *net_out) {
//net_out v + action
	double V1, V0;
	double y;
...
void ACICOControllerV14::output_policy(double *net_out, double *u)
{
	if (!USE_SAVED_RBF) {
...
void ACICOControllerV14::get_v_action_pairs(double* in, double* out) {
...
void ACICOControllerV14::submit_sample(double* in, double td_v, double td_actor, double perror) {
	Sample s;
...
void ACICOControllerV14::conduct_updates() {
	if (!USE_SAVED_RBF) {
...
void ACICOControllerV14::print_RBF_network_to_file(int epoch)
{
