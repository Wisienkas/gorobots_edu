...
void ACICOControllerV14::get_RBF_network_out(double* in, double* out) {
	double Value [2];
...
void ACICOControllerV14::submit_sample(double* input_old, double td_error, double pure_error, double actor_update_value) {
	Sample s;
	for (int i=0; i<XDIM; i++)
...
void ACICOControllerV14::update_critic_actor(double* input_old, double td_error
