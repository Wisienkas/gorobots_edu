...
//low pass filter
void ACICOControllerV14::signal_filter(const sensor* x_) {
...
void ACICOControllerV14::inner_controller(const sensor* x_, int number_sensors, motor* y_, int number_motors)
{
