...
//    preprosensor.at(i) = (sensor_output.at(i)>0)?1:0;
...
//      << ' ' << in0.at(L2_fs) << ' ' << preprosensor.at(L2_fs) << endl;
  outFilenpp1 << preprosensor.at(R0_fs) << ' ' << preprosensor.at(R1_fs) << ' ' << preprosensor.at(R2_fs) << ' '
              << preprosensor.at(L0_fs) << ' ' << preprosensor.at(L1_fs) << ' ' << preprosensor.at(L2_fs) << endl;
