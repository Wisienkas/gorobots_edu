...
// the robot
#include <ode_robots/amos4legs.h>
// the controller
...
class ThisSim : public lpzrobots::Simulation {
  public:
    ...
    virtual void start(const lpzrobots::OdeHandle& odeHandle, const lpzrobots::OsgHandle& osgHandle,
      ...
      // Add amosII robot
      lpzrobots::AmosFourConf myAmosFourConf = lpzrobots::AmosFour::getDefaultConf();
      lpzrobots::OdeHandle rodeHandle = odeHandle;
      rodeHandle.substance = lpzrobots::Substance(3.0, 0.0, 50.0, 0.8);
      amos = new lpzrobots::AmosFour(rodeHandle, osgHandle.changeColor(lpzrobots::Color(1, 1, 1)), myAmosFourConf,
          "myAmosFourConf");
