#ifndef EMG_ESN_APPROX_ESN_H
#define EMG_ESN_APPROX_ESN_H
...
#include "includes/networkmatrix.h" // XXX Include the networkmatrix last, otherwise it won't work!!!
...
public:
    ...
    EMGapproxESN(
        ...
        double = 0.33,                      // Leakage
        double = -1.0,                      // Pre-filtering discount factor
...
private:
    ...
    double leak, inputSparsity, internalSparsity, learningRate, error, preFiltLeakage, percentage_1, percentage_2;
    ...
    vector< double > preFilterPrev;
    double preFilterData( unsigned int, double, double = -1.0 );
