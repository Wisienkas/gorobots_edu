...
class ProgressBar( object ):
    ...
    Provides a universal, asinchronously running progress bar solution using the
    default Python GUI library only.

    Note: The program is a bit of a hack, as tkinter was not designed to run
    outside of the main thread, but it works the way it is implemented here
    nicely.
    """
    ...
    def printProgress( self, new_progress ):
        ...
        Replaces the graphical progress bar with a console version.
        """
    ...
    def showProgressBar( self ):
        ...
        Manages the tkinter thread and the updates.

        Internal function, don't call it from the outside.
        """
    ...
    def updateProgress( self, actual ):
        ...
        Call this function to update the progress bar. The parameter provided
        should indicate the portion - in percentage - of the work already done.
        """
    ...
    def stop( self, abort = False ):
        ...
        Stops the thread and closes the app.
        """
        self.stopFlag = True
