...
ESNetwork::ESNetwork( unsigned int num, std::string dir ) {
    ...
    //Why were they not here before?? Kris
    errors              = new float[outputNeurons];
    oldErrors           = new float[outputNeurons];
    oldOutputs          = new float[outputNeurons];
    oldIntermediates    = new float[networkNeurons];
...
//    std::cout << inputNeurons << std::endl;
//    std::cout << outputNeurons << std::endl;
//    std::cout << networkNeurons << std::endl;
//    std::cout << throughputConnections << std::endl;
//    std::cout << feedbackConnections << std::endl;
//    std::cout << leak << std::endl;
//    std::cout << RCneuronNoise << std::endl;
//    std::cout << withRL << std::endl;
//    std::cout << para_a << std::endl;
//    std::cout << para_b << std::endl;
//    std::cout << enable_IP << std::endl;
//    std::cout << leak_rate << std::endl;
//    std::cout << nonlinearity << std::endl;
//    std::cout << outnonlinearity << std::endl;
//    std::cout << InputWeightRange << std::endl;
}
