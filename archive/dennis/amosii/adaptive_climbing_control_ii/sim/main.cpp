...
//        lpzrobots::Playground* stair11 = new lpzrobots::Playground(playgroundHandle, osgHandle, osg::Vec3(2.0 + (0.25
//            + 2.0 + 1.0 + 0.5 + 0.75 + 0.5 + 0.75+ 1.0) * steplength, 1.0 * steplength, 0.66), 1, false);
//        lpzrobots::Playground* stair12 = new lpzrobots::Playground(playgroundHandle, osgHandle, osg::Vec3(2.0 + (0.25
//            + 2.0 + 1.0 + 0.5 + 0.75 + 0.5 + 0.75 + 3.0) * steplength, 2.0 * steplength, 0.72), 1, false);
...
//        stair11->setPosition(osg::Vec3(0, 0, .0));
//        stair12->setPosition(osg::Vec3(0, 0, .0));
...
//        global.obstacles.push_back(stair11);
//        global.obstacles.push_back(stair12);
      }
...
/*    	if(((AmosIIControl*) controller)->preprocessing_learning.countR > 9000
    			&& (globalData.sim_step % 10 == 0)
    		...
    		if(((AmosIIControl*) controller)->preprocessing_learning.countRmax<((AmosIIControl*) controller)->preprocessing_learning.countR){
    			...
    			((AmosIIControl*) controller)->preprocessing_learning.countR = 0;
    			std::cout << "Convergence Right" << endl;
    		}
    	}
    	if(((AmosIIControl*) controller)->preprocessing_learning.countL > 9000
    			&& (globalData.sim_step % 10 == 0)
    	    ...
    	    if(((AmosIIControl*) controller)->preprocessing_learning.countLmax<((AmosIIControl*) controller)->preprocessing_learning.countL){
    	  		...
    	  		((AmosIIControl*) controller)->preprocessing_learning.countL = 0;
    	  		std::cout << "Convergence Left" << endl;
    	    }
    	}
    	...
    	if(((AmosIIControl*) controller)->preprocessing_learning.ir_learnrate.at(25) == 0.0{
    			&& ((AmosIIControl*) controller)->preprocessing_learning.ir_learnrate.at(26) == 0.0
    			&& (globalData.sim_step % 10 == 0))
    		((AmosIIControl*) controller)->preprocessing_learning.convergence = true;
    		}*/
