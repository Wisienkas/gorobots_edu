...
public:
  ...
  //  global.odeConfig.setParam("gravity",-098.1);
    ...
    lpzrobots::TerrainGround* terrainground = new lpzrobots::TerrainGround(odeHandle,
        osgHandle, "rough6.ppm" /* "terrains/3potential_texture.ppm"-->ode_robots/osg/data/terrains/terrain_bumpInDip128.ppm*/," " /*ode_robots/osg/data/images/*/,3.0,3.0,0.006/*0.15, height*/);//3.0,3.0,0.05/*0.15, height*/);
    ...
    terrainground->setSubstance(lpzrobots::Substance::getPlastic(30));
...
/* stairs...*/
    //create_stairs_for_runbot(0.002,0.03,0,M_PI,8,osg::Vec3(0,0,0.01),myRunbotConf.armLength*myRunbotConf.scale);
    //create_stairs_for_runbot(0.03,0.001,M_PI,M_PI*1.5,6,osg::Vec3(0,0,0.01),myRunbotConf.armLength*myRunbotConf.scale);
    //create_step_for_runbot(-0.35*M_PI,1.1,0.001,osg::Vec3(0,0,0),myRunbotConf.armLength*myRunbotConf.scale);
 /* steps..*/
...
/* slope */
    //create_stairs_for_runbot(0.001,0.1,0,1.50*M_PI,18,osg::Vec3(0,0,0.01),myRunbotConf.armLength*myRunbotConf.scale);
