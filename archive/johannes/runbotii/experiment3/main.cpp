...
/* stairs...*/
    create_stairs_for_runbot(0.002,0.035,0,M_PI,8,osg::Vec3(0,0,0.01),myRunbotConf.armLength*myRunbotConf.scale);
    create_stairs_for_runbot(0.035,0.001,M_PI,M_PI*1.5,6,osg::Vec3(0,0,0.01),myRunbotConf.armLength*myRunbotConf.scale);
    create_step_for_runbot(-0.33*M_PI,1.3,0.001,osg::Vec3(0,0,0),myRunbotConf.armLength*myRunbotConf.scale);
 /* steps..*/
