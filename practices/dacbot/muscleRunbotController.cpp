...
: AbstractController (name,revision){
  ...
  addInspectableValue("state_u_hr_em",&nnet->state_u_hr_em,"state_u_hr_em");
  addInspectableValue("state_u_hl_em",&nnet->state_u_hl_em,"state_u_hl_em");
  addInspectableValue("state_u_hr_fm",&nnet->state_u_hr_fm,"state_u_hr_fm");
  addInspectableValue("state_u_hl_fm",&nnet->state_u_hl_fm,"state_u_hl_fm");
