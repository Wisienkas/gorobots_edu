...
class EmptyController : public AbstractController {
  public:
    ...
    virtual void step(const sensor* sensors, int sensornumber,
      ...
      outFileicolearning<<deri_xt_reflex_angle2<<' '<<k_ico[0]<<' '<<predictive_signal_green<<' '<<reflexive_signal_green<<' '
          <<deri_xt_reflex_angle3<<' '<<k_ico[1]<<' '<<predictive_signal_blue<<' '<<reflexive_signal_blue<<' '<<u_ico_out<<endl;
