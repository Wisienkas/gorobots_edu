...
const int num_hidden_ESN = 500; // Student Adjust!***
...
const double learning_rate_ESN = 0.98; // Student Adjust!***
...
//const int testing_start = 3500; /*training after, e.g., 4000 steps for "Input1_4033.txt"*/
