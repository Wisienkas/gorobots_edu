...
int main (int argc, char **argv)
{
  ...
  for (int i=1;i<BPM_ITER;i++) {
    ...
    if (use_file_data){
      ...
      //ifstream b_file ("TrainInput1.txt"); //2000 data, 2 column data, first column = input, second column = target
      //ifstream b_file ("TrainInput2.txt"); //2000 data, 2 column data, first column = input, second column = target
      ifstream b_file ("TrainInput3.txt"); //2000 data, 2 column data, first column = input, second column = target
      //ifstream b_file ("Train3Inputs.txt"); //2000 data, 4 column data, first column = input, second column = target
