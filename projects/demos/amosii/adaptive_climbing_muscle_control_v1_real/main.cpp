...
int main(int argc, char** argv) {
  ...
  for (unsigned int i = TR0_m; i < (BJ_m); i++) {
    ((AmosIIControl*) controller)->control_adaptiveclimbing.motormap.at(i)->max_ctr = 130.0;
    ((AmosIIControl*) controller)->control_adaptiveclimbing.motormap.at(i)->max_ctr_offset = 120.0;
  }
