	...
	virtual bool command(const lpzrobots::OdeHandle&,
		...
		if (down) { // only when key is pressed, not when released
			...
			case 'i':
										...
										break;
			case 'j':
							w_pfs_rfs = w_pfs_rfs-0.1;
							std::cout << "input weight:" << w_pfs_rfs << endl;
							//std::cout << w_pfs_rfs << endl;
							break;
			case 'k':
							w_pfs_rfs = w_pfs_rfs+0.1;
							std::cout << "input weight:" << w_pfs_rfs << endl;
			...
			case 'n':
							w_pfs_pfs = w_pfs_pfs-0.1;
							std::cout << "recurrent weight:" << w_pfs_pfs<< endl;
							//std::cout << w_pfs_pfs << endl;
		...
		if (newInput)
				{
					...
					rosInputScaled = rosInputScaled/2048-shift;
...
int main(int argc, char **argv) {
	...
	ros::NodeHandle n;
	//Init Subscriber
	ros::Subscriber sub = n.subscribe("bluetooth", 2000, RosCallback);
	chatter_pub = n.advertise<std_msgs::Float32>("amospub", 2000);
	chatter_pub2 = n.advertise<std_msgs::Float32>("amospub2", 2000);
	//End of ROS stuff
