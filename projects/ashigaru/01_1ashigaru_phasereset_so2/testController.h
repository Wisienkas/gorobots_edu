...
typedef struct TestControllerConf {
    double WeightH1_H1;
    double WeightH2_H2;
    double WeightH1_H2;
    double WeightH2_H1;
...
class TestController : public AbstractController {
  ...
  public:
    TestController(const TestControllerConf& conf = getDefaultConf());
    ...
    // default config
    static TestControllerConf getDefaultConf();
