...
NeuralLocomotionControlAdaptiveClimbing::NeuralLocomotionControlAdaptiveClimbing(){
		  ...
		  outFootcontact.open("FootContactSensor.txt");
...
*******************************************************************************/
		...
		else // using normal control
		{
			...
			outFootcontact<<in0.at(R0_fs)<<"\t"<<in0.at(R1_fs)<<"\t"<<in0.at(R2_fs)<<"\t"<<in0.at(L0_fs)<<"\t"<<in0.at(L1_fs)<<"\t"<<in0.at(L2_fs)<<endl;
		}
