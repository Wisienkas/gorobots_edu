...
int main(int argc, char** argv) {
	...
	AbstractController* controller = new AmosIIControl(/*AMOSv2*/2,/*MCPGs=true*/false,/*Muscle Model =true*/false);
	...
	while(!stop) {
		...
		if (1==1){//key==101){ //E
			if (1==1){//((AmosIIControl*) controller)->control_adaptiveclimbing->switchon_allreflexactions) {
