...
#include <NimmExp1.h> // ICO + AC 3 goals no obstacle
...
public:
	...
	void generate_spheres(GlobalData& global)
	{
		...
		for (int i=0; i < number_spheres; i++){
			...
			if (i==2) s1->setPosition(osg::Vec3(20.0 /*position_S*/, position_S+7, 3/*0*/)); //Green Sphere

			//Target 3./s
			//if (i==2) s1->setPosition(osg::Vec3(15-11.0 /*position_S*/, position_S-10, 0.5/*0*/));
			if (i==1) s1->setPosition(osg::Vec3(4.0 /*position_S*/, position_S + 3, 3/*0*/)); //Blue sphere
