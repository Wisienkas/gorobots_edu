 ...
 *                                                                         *
 ***************************************************************************/
#ifndef __NEURALRLHOMEOKMCONTROLLER_H
#define __NEURALRLHOMEOKMCONTROLLER_H
...
struct NeuralRLHomeoMControllerConf {
	int number_qlearner;
} ;
 ...
 */
class NeuralRLHomeokMController : public AbstractController {

public:
	NeuralRLHomeokMController(const NeuralRLHomeoMControllerConf& conf = getDefaultConf());
	virtual void init(int sensornumber, int motornumber, RandGen* randGen = 0);

	virtual ~NeuralRLHomeokMController();
  ...
  virtual paramlist getParamList() const;
	...
	static NeuralRLHomeoMControllerConf getDefaultConf(){
		NeuralRLHomeoMControllerConf c;
		c.number_qlearner =1;
		return c;
	}
	...
	OpenInvertNChannelController* homeokinetic_controller;
	bool learn;
protected:
	...
	std::vector<double> lweight, rweight; // weights to adapt

	 RandGen* randGen;


	NeuralRLHomeoMControllerConf conf;
	int t;
